...
function removeItem(id){
  // console.log(id);
  // loop though cart and check id passed in against each element // IDEA
  for(let index in cart){
    if (id === cart[index].id){
      // remove item using aplice method
...
// calculate total from cart and display in nesessary places
function showTotal(){
  let total = 0;
  for (let index in cart){
